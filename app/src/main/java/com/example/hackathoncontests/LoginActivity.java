...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String listContests[] = {"June App Lab Meetup","Supernova","Microsoft Azure","TRON Grand Hackathon","aelf Web3.0 Hackathon",
    ...
    int listImages[] = {R.drawable.im0,R.drawable.im1,R.drawable.im2,R.drawable.im3,R.drawable.im4,
